''' 
simulategeneral.py: simulates data under a more general mediation model
where M is affected directly by G and G*, where M affects Y, and where Y
in addition is affected directly by G and G'
'''
import numpy as np
import pandas as pd
import sys
...
def SimulatePhenotypes(mG,miID,iRun,rng):
    ...
    vY = mX@vBetaY + vM*dB + vG*dGY + vGT*dGTY + vE*dEY
    ...
    # construct DataFrame phenotypes
